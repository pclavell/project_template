...
def test_setup_project_real(tmp_path):
    ...
    user_dir = tmp_path
    repo_dir = tmp_path / setup_project.TEMPLATE_PROJECT_NAME
    ...
    setup_project.main(dry_run=False,
        repo_dir=repo_dir,
        resources=res_file,
        output_resources=str(tmp_path / "output_resources.yml"))
